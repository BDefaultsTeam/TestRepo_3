...
!function () {
	    ...
	    a.exports.tabPage = function (b) {
			...
			g = function () {
			    ...
			    if ($(window).width() < 726) {
			        ...
			        $('#PCBContainer').css('font-size', '11px');
			        $('#PCBContainer #PCBContent .pcbbtn').css('background-size', '20%');
			        $('#PCBContainer #PCBContent .pcbbtn').css('background-position-x', '70%');
			    }
			    else {
			        $('#links span').css('margin-right', '16px');
			        $('#links .links-button').css('margin', '12px 8px 8px');

			        $('#PCBContainer').css('font-size', '13px');
			        $('#PCBContainer #PCBContent .pcbbtn').css('background-size', 'initial');
			        $('#PCBContainer #PCBContent .pcbbtn').css('background-position-x', '95%');
			    }
    ...
    $(document).click(function (event) {
       targetIdClick = event.target.id;
        
       if (filteredLinksIdArray.find(findTargetId)) {
            if (keyCode == 13) {
                setTimeout(function () {
                    sendJSLLPing(typeof (awa) == "undefined" ? null : awa.behavior.CLICK, "KE", targetIdClick + "-LinkClick")
                }, 500);
                keyCode = 0;
            }
            else {
                setTimeout(function () {
                    sendJSLLPing(typeof (awa) == "undefined" ? null : awa.behavior.CLICK, "CL", targetIdClick + "-LinkClick")
                }, 500);
            }
        }
    });
