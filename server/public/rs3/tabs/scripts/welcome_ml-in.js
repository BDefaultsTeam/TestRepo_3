	...
	function () {
	    a.exports.tabPage = function (b) {
			...
			g = function () {
			    ...
			    $('#links .links-button').css('font-size', z + 'px'),
			    $('#speedGetStarted').css('font-size', z + 'px'),
			    $('#welcome-tagline').css('font-size', zz + 'px')
			    ...
			    if ($(window).width() < 926) {
			        $('#links .links-button').css('padding', '0 0.5em');
			    }
			    else {
			    ...
			    {
			        $('#welcome-tagline').css('font-size', '22px')
			    }
