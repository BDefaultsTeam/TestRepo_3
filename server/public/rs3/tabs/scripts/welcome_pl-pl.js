	    ...
	    a.exports.tabPage = function (b) {
			...
			g = function () {
			    ...
			    if ($(window).width() < 750) {
			        ...
			        $('#welcome-tagline1').css('font-size', d * 1.8);
			        $('#welcome-tagline2').css('font-size', d * 1.8);
			        $('#welcome-tagline3').css('font-size', d * 1.8);
			    }
			    else {
			        $('#links span').css('margin-right', '16px');
			        $('#links .links-button').css('margin', '12px 8px 8px');

			        $('#welcome-tagline1').css('font-size', 'inherit');
			        $('#welcome-tagline2').css('font-size', 'inherit');
			        $('#welcome-tagline3').css('font-size', 'inherit');
			    }
