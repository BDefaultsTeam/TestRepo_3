...
function init() {
    try {
        loadJSON(function (response) {
            ...
            document.getElementById("speedBasedOn").innerHTML = actual_JSON.speedBasedOn;
            document.getElementById("speedDetailsHere").innerHTML = actual_JSON.speedDetailsHere;
