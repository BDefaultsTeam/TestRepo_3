...
(function () {
    ...
    (function () {
        ...
        app.exports.speedPage = function (data) {
            ...
            var resize = function () {
                ...
                //To fix text wrap issue
                $('#speedFaster').css('font-size', scale * 2);
                $('#speedGooglesBenchmark').css('font-size', scale * 2);

                // Button font resize 
                if ($(window).width() < 1080) {

                    var browserWidth = $(window).width();
                    var btnFontScale = 100;
            ...
            var edgeDial = new app.exports.speedPage.SpeedDial(
            ...
            var chromeDial = new app.exports.speedPage.SpeedDial(
                document.getElementById("chrome-dial-canvas"), {
                    minValue: min,
                    maxValue: max,
                    valueImageUrl: "../images/chrome-dial-value.png",
                    marksImageUrl: "../images/chrome-dial-marks.png",
                    pointerImageUrl: "../images/chrome-dial-pointer.png",
                    labelUpdateFrameFreq: 4
                });

            var ffDial = new app.exports.speedPage.SpeedDial(
                document.getElementById("ff-dial-canvas"), {
                    minValue: min,
                    maxValue: max,
                    valueImageUrl: "../images/ff-dial-value.png",
                    marksImageUrl: "../images/ff-dial-marks.png",
                    pointerImageUrl: "../images/ff-dial-pointer.png",
                    labelUpdateFrameFreq: 4
                });

            var animateDialLabel = function (label, from, value, dur) {
                var lbl = { v: from };
                TweenLite.to(lbl, dur, {
                    v: value, ease: Expo.easeInOutm, onUpdate: function () {
            ...
            var startDials = function () {
                ...
                et.addCallback(function () {
                    ...
                    $('.edge-dial-column h3').addClass('show-final');
                }, '-=2.5');
    ...
    var filteredLinksIdArray = ["link-bookmarks", "link-extensions", "link-new", "speedDetailsHere"];
    var keyCode = 0;
