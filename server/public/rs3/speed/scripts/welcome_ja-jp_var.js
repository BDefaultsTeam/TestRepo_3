...
(function () {
    ...
    $("#bPausePlay").click(function () {
        if (pausePlay) {
            ...
            pausePlay = false;
            "undefined" != typeof MscomCustomEvent && MscomCustomEvent("ms.InteractionType", "101", "cn", "video-play");
            "undefined" != typeof (awa) && sendJSLLPing(awa.behavior.VIDEOSTART, "CL", "video-play");
        }
        else {
            ...
            pausePlay = true;
            "undefined" != typeof MscomCustomEvent && MscomCustomEvent("ms.InteractionType", "101", "cn", "video-pause");
            "undefined" != typeof (awa) && sendJSLLPing(awa.behavior.VIDEOPAUSE, "CL", "video-pause");
        }
        if (!videoFlag) {
            linksBounce();
        }
