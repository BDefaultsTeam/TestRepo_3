...
(function () {
    ...
    (function () {
        ...
        app.exports.speedPage = function (data) {
            ...
            intro.add([
                ...
                TweenMax.fromTo('.dials', 1, { opacity: 0, x: 80 }, { opacity: 1, y: 0, ease: CustomEase.get("softBounce") })
            ], '-=1.5');

            intro.add([
                TweenMax.to('.welcome', 1, { top: 0, ease: CustomEase.get("softBounce") }),
            TweenMax.fromTo('.secondtext1', 1, { opacity: 0, x: 80 }, { opacity: 1, y: 0, ease: CustomEase.get("softBounce") })
            ], '-=1.5');

            intro.add([
                TweenMax.to('.welcome', 1, { top: 0, ease: CustomEase.get("softBounce") }),
            TweenMax.fromTo('.secondtext2', 1, { opacity: 0, x: 80 }, { opacity: 1, y: 0, ease: CustomEase.get("softBounce") })
            ], '-=1.5');
    ...
    $(document).click(function (event) {
       // alert(event.target.id);
        ...
        var comparisonResult = filteredLinksIdArray.find(function (currentValue, index, arr) {
            return currentValue.includes(targetId);
        });
