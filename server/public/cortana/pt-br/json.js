...
function init(market) {
    try {
        loadJSON(market, function (response) {
            ...
            document.getElementById("imgCortanaExpand").setAttribute("alt", actual_JSON.Alt.Safetyillustration);
            document.getElementById("imgCortana").setAttribute("alt", actual_JSON.Alt.Safetyshield);
            ...
            document.getElementById("imgCortana").setAttribute("aria-label", actual_JSON.AriaLabel.AriaLabel3);
