...
function init(market) {
    try {
        ...
        loadJSON(market, function (response) {
            ...
            //  document.getElementById("img_number2_text").innerHTML = document.getElementById("img_number2_hover_text").innerHTML = actual_JSON.Tabs.Tab2;
            ...
            // document.getElementById("img_number3_text").innerHTML = document.getElementById("img_number3_hover_text").innerHTML = actual_JSON.Tabs.Tab3;
            ...
            document.getElementById("imgFavorites").setAttribute("alt", actual_JSON.Alt.Favoritesillustration);
            ...
            document.getElementById("imgFavorites").setAttribute("aria-label", actual_JSON.AriaLabel.AriaLabel2);
